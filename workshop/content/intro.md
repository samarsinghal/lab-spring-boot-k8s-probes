Spring Boot comes with features that make it work well in Kubernetes. This lab shows you how to add [liveness and readiness probes](https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#container-probes) to a Spring Boot application in Kubernetes. This lab will cover the following tasks:
