Spring Boot comes with features that make it work well in Kubernetes. This lab shows you how to add liveness and readiness probes to a Spring Boot application in Kubernetes. To do this we need to do two things:
